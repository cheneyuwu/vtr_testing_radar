...
python -m pyboreas.eval.localization --gt ${VTRRDATA} --pred ${VTRRRESULT}/${ODO_INPUT}/localization_result --ref_seq ${ODO_INPUT} --ref_sensor lidar --test_sensor lidar --dim 3  --plot ${VTRRRESULT}/${ODO_INPUT}/localization_result
