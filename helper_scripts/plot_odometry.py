...
def main(odo_dir):
  odo_dirs = [
      '/home/yuchen/ASRL/temp/lidar/aeva/boreas-2022-05-06-15-22.no_rv/boreas-2022-05-06-15-22',
      '/home/yuchen/ASRL/temp/lidar/aeva/boreas-2022-05-06-15-22.rv/boreas-2022-05-06-15-22'
  ]

  rclpy.init()
  node = Node("boreas_player")

  for i, odo_dir in enumerate(odo_dirs):
    ...
    odometry_path_publisher = node.create_publisher(nav_msgs.Path, '/odometry_path' + str(i), 10)
