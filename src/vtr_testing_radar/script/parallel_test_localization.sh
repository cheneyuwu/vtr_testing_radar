...
LOCALIZATION_SCRIPT="${VTRRROOT}/src/vtr_testing_radar/script/test_localization.sh"
LOCALIZATION_EVAL_SCRIPT="${VTRRROOT}/src/vtr_testing_radar/script/test_localization_eval.sh"
...
for seq in ${SEQUENCES[@]}; do
  echo "Executing command: bash $LOCALIZATION_EVAL_SCRIPT $REFERENCE $seq"
  bash $LOCALIZATION_EVAL_SCRIPT $REFERENCE $seq
done
