...
python -m pyboreas.eval.localization_aeva --gt ${VTRRDATA} --pred ${VTRRRESULT}/${ODO_INPUT}/localization_result --ref_seq ${ODO_INPUT} --ref_sensor aeva --test_sensor aeva --dim 2  --plot ${VTRRRESULT}/${ODO_INPUT}/localization_result/lidar-lidar
